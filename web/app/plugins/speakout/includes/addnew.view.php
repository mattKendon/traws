				...
				<div class="inside">
					...
					<div class="dk-speakout-petition-content">
						<div class="dk-speakout-email-headers">
							<label for="target_email"><?php _e( 'Target Email', 'dk_speakout' ); ?> <span class='normalText'>you may enter multiple addresses separated by commas</span></label> 
					...
					<div id="minor-publishing">
						...
						<div class="misc-pub-section">
							<div class="dk-speakout-checkbox">
								...
								<label for="is_editable" class="dk-speakout-inline"><?php _e( 'Allow message to be edited', 'dk_speakout'); ?></label>
							</div>
						</div>
