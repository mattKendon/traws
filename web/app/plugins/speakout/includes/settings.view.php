<div class="wrap" id="dk-speakout">
	...
	<h2><?php _e( 'SpeakOut! Petitions Settings', 'dk_speakout' ); ?></h2>
	...
	<form action="" method="post" id="dk-speakout-settings">
		...
		<div id="dk-speakout-tab-01" class="dk-speakout-hidden dk-speakout-tabcontent">
			...
			<table class="form-table">
				...
				<tr valign="top">
					<th scope="row"><?php _e( 'Display BCC field', 'dk_speakout' ); ?></th>
					<td>
						<label for="display-bcc-yes" /><input type="radio" name="display_bcc" id="display-bcc-yes" value="enabled" <?php if ( $the_settings->display_bcc == 'enabled' ) echo 'checked="checked"'; ?> /> <?php _e( 'Yes', 'dk_speakout' ); ?></label>
						<label for="display-bcc-no" /><input type="radio" name="display_bcc" id="display-bcc-no" value="disabled" <?php if ( $the_settings->display_bcc == 'disabled' ) echo 'checked="checked"'; ?> /> <?php _e( 'No', 'dk_speakout' ); ?></label>
					</td>
				</tr>
			</table>
		</div>
