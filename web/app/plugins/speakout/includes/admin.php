...
function dk_speakout_create_menus() {
	...
	// load sidebar menus
	$petitions = array(
		'page_title' => __( 'SpeakOut! Email Petitions', 'dk_speakout' ),
		'menu_title' => __( 'Speakout!', 'dk_speakout' ),
	...
	$settings = array(
		'parent_slug' => 'dk_speakout',
		'page_title'  => __( 'SpeakOut! Petitions Settings', 'dk_speakout' ),
	...
	$import = array(
		...
		'menu_title'  => __( 'Import from SpeakUp', 'dk_speakout' ),
		'capability'  => 'manage_options',
