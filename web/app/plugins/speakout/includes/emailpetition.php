	...
	if ( isset( $attr['id'] ) && is_numeric( $attr['id'] ) ) {
		...
		if ( $petition_exists ) {
			...
			if ( ! $expired ) {
				...
				$petitionReadTitle = $petition->is_editable ?  __( 'Read or edit the petition', 'dk_speakout' ) :  __( 'Read the petition', 'dk_speakout' ) ;
				$petition_form = '
					...
					<div class="dk-speakout-petition-wrap ' . $css_classes . '" id="dk-speakout-petition-' . $petition->id . '" ' . $width . '>
						...
						<a id="dk-speakout-readme-' . $petition->id . '" class="dk-speakout-readme" rel="' . $petition->id . '" style="display: none;"><span>' . __( $petitionReadTitle , 'dk_speakout' ) . '</span></a>
				...
				if ( $options['display_bcc'] == 'enabled' ) {
				    $petition_form .= '
								...
								<label for="dk-speakout-bcc-' . $petition->id . '">' . __( 'BCC yourself', 'dk_speakout' ) . '</label>
							</div>';
				}
